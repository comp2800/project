...
public class Pebbles extends Behavior {
    ...
    private final int[] trajectories = new int[25];
...
//            rotation.rotX(Math.PI / new Random().nextInt(4) + 1);
//            rotation.rotY(Math.PI / new Random().nextInt(4) + 1);
//            rotation.rotZ(Math.PI / new Random().nextInt(4) + 1);
//            trans3d.mul(rotation);
