...
//        ring.setAppearance(setApp("Imports/Textures/SolarSystem/Saturn_Ring.png"));
//        Transform3D ringT3D = new Transform3D();
//        ringT3D.setScale(2);
//        TransformGroup ringTG = new TransformGroup(ringT3D);
